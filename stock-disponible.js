  ...
  "FN-TRAN-SFP+LR": { name: "Transceiver SFP+ 10GE Long Range", desc: "Módulo transceiver 10GE SFP+ de largo alcance para FortiSwitch.", price: "$145.339", pricenote: "IVA incluido", specs: ["10GE SFP+ Long Range", "Compatible con switches FortiSwitch con puertos SFP+", "Alcance extendido para enlaces entre edificios o pisos"], datasheet: null },
  "FN-TRAN-SFP+SR": { name: "Transceiver SFP+ 10GE Short Range", desc: "Módulo transceiver 10GE SFP+ de corto alcance para FortiSwitch.", price: "$87.249", pricenote: "IVA incluido", specs: ["10GE SFP+ Short Range", "Compatible con switches FortiSwitch con puertos SFP+", "Ideal para enlaces dentro del mismo rack o sala"], datasheet: null },
  "FN-TRAN-SX": { name: "Transceiver SFP 1GE SX", desc: "Módulo transceiver 1GE SFP SX para FortiSwitch.", price: "$73.134", pricenote: "IVA incluido", specs: ["1GE SFP SX", "Compatible con switches FortiSwitch con puertos SFP", "Fibra multimodo, corto alcance"], datasheet: null },
};
